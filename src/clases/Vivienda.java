...
public class Vivienda{
	...
	public void setDireccion(String direccion) {
	  if (direccion != null && !direccion.trim().isEmpty()) {
	    if(direccion.matches("[a-zA-ZáéíóúÁÉÍÓÚñÑ1234567890 ]+"))
   ...
   if (largo <=0) {
    ...
    if(largo*ancho> 50)
     throw new IllegalArgumentException("El área máxima de una vivienda no puede exceder los 50m². Ajuste el largo y ancho para que no suceda esto");
     else
		    this.largo = largo;
	}
