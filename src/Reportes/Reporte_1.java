...
public class Reporte_1 extends JFrame {
	...
	public JLabel getLblTipoII() {
		if (lblTipoII == null) {
			...
			lblTipoII.setBounds(232, 52, 92, 14);
		}
		return lblTipoII;
	}
	public JLabel getLblTipoIII() {
		if (lblTipoIII == null) {
			...
			lblTipoIII.setBounds(232, 97, 92, 14);
		}
		return lblTipoIII;
	}
	public JLabel getLblTipoV() {
		if (lblTipoV == null) {
			...
			lblTipoV.setBounds(232, 142, 92, 14);
		}
		return lblTipoV;
	}
	public JLabel getLblTipov() {
		if (lblTipov == null) {
			...
			lblTipov.setBounds(232, 187, 92, 14);
		}
		return lblTipov;
	}
	public JTextPane getTxtpneste() {
		if (txtpneste == null) {
			...
			txtpneste.setBounds(10, 11, 212, 190);
		}
		return txtpneste;
	}
